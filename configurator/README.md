...
A página inicial preserva a arquitetura nova de SEO, clientes e produtos, mas recupera a direção visual anterior: navegação flutuante, hero de duas colunas e mockup de operações com cartões de status.
